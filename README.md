...
A dataset is a combination of many variables over many years. They consist of 3 netCDF files (train.yml, test.yml and val.yml) and a YML ds-config.yml file. To combine the variables they must have:
